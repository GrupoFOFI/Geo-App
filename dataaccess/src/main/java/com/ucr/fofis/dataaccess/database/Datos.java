...
public class Datos {
    ...
    public final static ArrayList<Punto> PUNTOS = new ArrayList<Punto>() {
        {
            add(new Punto(1,"Punto1",null, new GeoPoint(10.9514833333333,-85.7151),300.0d,new int[]{R.drawable.punto_01_1,R.drawable.punto_01_2,R.drawable.punto_01_3},0,R.raw.audio_1bl,0));
            ...
            add(new Punto(5,"Punto5",null, new GeoPoint(10.98176182858,-85.7177965097929),50.0d,new int[]{R.drawable.punto_05_1,R.drawable.punto_05_2},0,R.raw.audio_5bl,0));
            add(new Punto(6,"Punto6",null, new GeoPoint(10.9821743821365,-85.7190790800442),50.0d,new int[]{R.drawable.punto_06_1,R.drawable.punto_06_2},0,R.raw.audio_6bl,0));
            add(new Punto(7,"Punto7",null, new GeoPoint(10.9839,-85.7189),50.0d,new int[]{R.drawable.punto_07_1},0,R.raw.audio_7bl,0));
            add(new Punto(8,"Punto8",null, new GeoPoint(11.0016833333333,-85.748105),200.0d,new int[]{R.drawable.punto_08_1,R.drawable.punto_08_2, R.drawable.punto_08_2a},0,R.raw.audio_8bl,0));
            add(new Punto(9,"Punto9",null, new GeoPoint(11.0361333333333,-85.7485833333333),500.0d,new int[]{R.drawable.punto_09_1},0,R.raw.audio_9bl,0));
            add(new Punto(10,"Punto10",null, new GeoPoint(11.0381333333333,-85.7387166666666),100.0d,new int[]{R.drawable.punto_10_1,R.drawable.punto_10_1a},0,R.raw.audio_10bl,0));
            add(new Punto(11,"Punto11",null, new GeoPoint(11.0448166666666,-85.7417),200.0d,new int[]{R.drawable.punto_11_1,R.drawable.punto_11_2},0,R.raw.audio_11bl,0));
            add(new Punto(12,"Punto12",null, new GeoPoint(11.0462333333333,-85.7380666666666),200.0d,new int[]{R.drawable.punto_12_1,R.drawable.punto_12_2},0,R.raw.audio_12bl,0));
