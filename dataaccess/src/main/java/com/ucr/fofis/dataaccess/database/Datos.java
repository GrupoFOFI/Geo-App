    ...
    public final static ArrayList<Punto> PUNTOS = new ArrayList<Punto>() {
        {
            ...
            add(new Punto(6,"Punto 6",null, new GeoPoint(10.9821743821365,-85.7190790800442),50.0d,new int[]{R.drawable.punto_06_1,R.drawable.punto_06_2},R.raw.video06_3,new int[]{R.raw.audio6b},0));
            add(new Punto(7,"Punto 7",null, new GeoPoint(10.9839,-85.7189),50.0d,new int[]{R.drawable.punto_07_1},0,new int[]{R.raw.audio7b},0));
            add(new Punto(8,"Punto 8",null, new GeoPoint(11.0016833333333,-85.748105),200.0d,new int[]{R.drawable.punto_08_1,R.drawable.punto_08_2, R.drawable.punto_08_2a},R.raw.video08_3,new int[]{R.raw.audio8b},0));
            add(new Punto(9,"Punto 9",null, new GeoPoint(11.0361333333333,-85.7485833333333),500.0d,new int[]{R.drawable.punto_09_1},R.raw.video09_6,new int[]{R.raw.audio9b},0));
            ...
            add(new Punto(14,"Punto 14",null, new GeoPoint(11.0457666666666,-85.7219),200.0d,new int[]{R.drawable.punto_14_1,R.drawable.punto_14_2, R.drawable.punto_14_3},R.raw.video14_4,new int[]{R.raw.audio14b},0));
            add(new Punto(15,"Punto 15",null, new GeoPoint(11.0466881500087,-85.7075191718204),100.0d,new int[]{R.drawable.punto_15_1, R.drawable.punto_16_1,R.drawable.punto_17_1,R.drawable.punto_17_2, R.drawable.punto_17_3,R.drawable.punto_18_1},R.raw.video15_2,new int[]{R.raw.audio17b},0));
