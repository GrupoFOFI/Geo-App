    ...
    public final static ArrayList<Punto> PUNTOS = new ArrayList<Punto>() {
        {
            ...
            add(new Punto(3,"El sinclinal de Bahía Junquillal",null, new GeoPoint(10.9698798844808,-85.7271389630961),600.0d,new Resource[]{new Resource(R.drawable.punto_03_1,"")}, new Resource(0,""),new Resource[]{new Resource(R.raw.audio3b, "")},new Resource(R.drawable.anim3_4,"")));
